...
public class ExceptionHandlingAspect {
    ...
    public Object handleExceptions(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            if (openAIError != null) {
                throw new CommonException(openAIError.getOverview(), openAIError.name(), openAIError.getSolution());
            } else {
                throw new CommonException("Unknown Error: " + e.getResponseBodyAsString(), "UNKNOWN", "Please contact supports.");
            }
        } catch (Exception e) {
            System.out.println("Caught exception of type: " + e.getClass().getName());
            // 处理其他异常
            throw new CommonException("System Error: " + e.getMessage(), "SYSTEM_ERROR", "Please contact supports.");
        }
    }
